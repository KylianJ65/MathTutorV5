...
int GenerateRandomQuestion(int mathLevel) {
    int leftNum =0;
    int rightNum = 0;
    int correctAnswer = 0;
    int totalCorrect = 0;
...
int main() {
    ...
    for(int i =0; i < MAX_ATTEMPTS; i++) {
        GenerateRandomQuestion(mathLevel);
    }
